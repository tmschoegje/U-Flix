#file where i mess around with searching the index and presenting the results
#the one in 'production' is in /webserver
...
def prepareResultsURL(response, q):
	res = "> " + q + "\n"
...
def printResultsURL(response, q):
	print(prepareResultsURL(response, q))
